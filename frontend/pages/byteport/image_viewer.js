...
class ImageViewer {
    ...
    open(fileId, fileName, mimeType) {
        ...
        if (mimeType.startsWith('image/')) {
            ...
            this.imgElement.src = `/api/byteport/view/${fileId}`;
            ...
            this.pdfElement.src = `/api/byteport/view/${fileId}`;
            ...
            // set source and load
            this.videoElement.src = `/api/byteport/view/${fileId}`;
            ...
            this.audioElement.src = `/api/byteport/view/${fileId}`;
    ...
    download() {
        window.location.href = `/api/byteport/download/${this.currentFileId}`;
    }
